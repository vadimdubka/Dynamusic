...
<body bgcolor="#ffffff">
	...
	SongsManager.repository.repositoryName:
	<dsp:valueof bean="SongsManager.repository">unset</dsp:valueof>
	<br> Now attempting to delete albums
	<br>
...
You must set artistId to a value (append "?artistId=xxxx" to the URL and reload).  
       ...
       Artist Id = <dsp:valueof param="artistId">unset</dsp:valueof>
			<br>
